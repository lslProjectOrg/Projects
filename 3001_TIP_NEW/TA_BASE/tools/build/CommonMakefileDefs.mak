...
#-----
#OMNI_VER	= omniORB_4.0.5
#OMNI_VER	= omniORB_4.1.4
OMNI_VER	= omniORB_4.1.6
#BOOST_VER	= boost_1_31_0
BOOST_VER	= boost_1_39_0
#ORACLE_VER	= 920
ORACLE_VER	= 10.2.0
MYSQL_VER   = 5.5.15
MCL_VER     = 1.1.0
...
ifeq ($(OPERATING_SYSTEM), SUNOS)
	...
	MCL_LIB_DIR = $(PROJ_ROOT_DIR)/code/cots/mcl/$(MCL_VER)/lib/$(OPERATING_SYSTEM)_$(OP_SYS_VERSION)_$(ARCHITECTURE)
...
ifeq ($(OPERATING_SYSTEM), LINUX)
	OMNI_BIN = $(PROJ_ROOT_DIR)/code/cots/omniORB/$(OMNI_VER)/build_linux_TODO/bin
	OMNI_LIB = $(PROJ_ROOT_DIR)/code/cots/omniORB/$(OMNI_VER)/build_linux_TODO/lib
	BOOST_LIB = $(PROJ_ROOT_DIR)/code/cots/boost/$(BOOST_VER)/libs/linux
	ACE_LIB_DIR = $(PROJ_ROOT_DIR)/code/cots/ACE/$(ACE_VER)/ace
	ORACLE_DIR = $(PROJ_ROOT_DIR)/code/cots/oracle/$(ORACLE_VER)/linux
        MYSQL_DIR = $(PROJ_ROOT_DIR)/code/cots/mysql/$(MYSQL_VER)/linux
	MCL_LIB_DIR = $(PROJ_ROOT_DIR)/code/cots/mcl/$(MYSQL_VER)/lib/linux
	MCL_SRC_DIR = $(PROJ_ROOT_DIR)/code/cots/mcl/$(MCL_VER)
	CURL_DIR = $(PROJ_ROOT_DIR)/code/cots/curl/$(CURL_VER)/build/lib
	OPENSSL_DIR = $(PROJ_ROOT_DIR)/code/cots/openssl/$(OPENSSL_VER)/build/lib/$(OPERATING_SYSTEM)_$(OP_SYS_VERSION)_$(ARCHITECTURE)
	OPENSSL_BIN = $(PROJ_ROOT_DIR)/code/cots/openssl/$(OPENSSL_VER)/build/bin/$(OPERATING_SYSTEM)_$(OP_SYS_VERSION)_$(ARCHITECTURE)
	PLATFORM_OS := linux
endif
...
ifeq ($(OPERATING_SYSTEM), LINUX)
BASE_CFLAGS	+= -c -Wall -DSTL_HAS_DEFAULT_ARGS -DUsePthread \
					-D_REENTRANT \
					-D$(PROCESSOR) \
					-D$(OPERATING_SYSTEM) 
...
#TP_LIBS +=       omniORB4 omniDynamic4 omnithread COS4 boost_filesystem-gcc-mt-1_31 boost_regex-gcc-mt-1_31
