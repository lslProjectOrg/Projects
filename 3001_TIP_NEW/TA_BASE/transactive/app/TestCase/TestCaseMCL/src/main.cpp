...
int main()
{
	...
	TA_Base_Core::DebugUtil::getInstance().setFile("./output/LOG_TestCaseMCL.log");
...
// #define RPARAM_DBOFFLINE            "DataBaseBad"
	...
	//mysql
	TA_Base_Core::RunParams::getInstance().set("DataBase_tra_occ@192.168.123.43","DataBaseGood");
	TA_Base_Core::RunParams::getInstance().set(RPARAM_DBCONNECTION,"Mysql,IT271350_5,IT271350_5");
	...
	try
	{
		...
		runner.begin( "./cfg/config_TestCaseMCL.ini" );
	}
	catch (...)
	{
