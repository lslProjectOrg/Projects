/**
  ...
  * in any form.
  *
  * Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/SimpleDbDatabase.h $
  * @author Nick Jardine
  * @version $Revision: #8 $
...
#include "core/database/src/SQLCode.h"
...
namespace TA_Base_Core
{
	...
	public:
		 ...
		 */
		virtual IData* executeQuery(const SQLStatement& rSqlObj, const std::vector<std::string>& columnNames, const unsigned long numRows );
