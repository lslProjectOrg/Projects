...
//////////////////////////////////////////////////////////////////////
#ifndef __CLASS_SQLITECONNECTION_H__
#define __CLASS_SQLITECONNECTION_H__
...
public:
	...
	*/
	SQLiteConnection(const std::string& connectionStr, 
...
private:
	...
	*/
	...
	CppSQLite3DB* m_pConnection;
	//	sql::Statement*  m_pStatment;
};

NS_END(TA_Base_Core)

#endif /// __CLASS_SQLITECONNECTION_H__