...
* in any form.
*
* Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/database/src/OCIConnection.cpp $
* @author:  Ripple
* @version: $Revision: #6 $
*
* Last modification: $DateTime: 2013/09/26 15:27:41 $
...
// 	}
	...
	void OCIConnection::_GetSQL(std::string& strSql, const SQLStatement& rSqlObj)
	{
		...
		else if (!rSqlObj.strOracleSQL.empty())
		{
			strSql = rSqlObj.strOracleSQL;
		}
		else
		{
			strSql.clear();
