...
/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/synchronisation/src/ReadWriteThreadLockable.h $
...
namespace TA_Base_Core
{
	...
	private:
		...
		CTASemaphore m_semReaders;
		CTASemaphore m_semWriters;
