...
)
{
	...
	//lsl--delete code	OCI_MsgSetSender(msg, NULL)
    res =   (
...
)
{
    ...
    if (obj != NULL)
    {
		...
		//lsl--edit! not use OCI_ObjectAssign 	
#if 0
        res = OCI_ObjectAssign((OCI_Object *) msg->obj, obj);
#endif
		if (msg->obj->typinf->tdo == obj->typinf->tdo)
		{
			msg->obj->handle = NULL;
			msg->obj->handle = obj->handle;	

			msg->obj->typinf = obj->typinf;
			
			OCI_ObjectReset(msg->obj);
		}
