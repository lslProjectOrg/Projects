/**
  ...
  * in any form.
  *
  * Source:   $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/utilities/src/Hostname.cpp $
  * @author:  Ripple
  * @version: $Revision: #2 $
  *
...
namespace TA_Base_Core
{
    ...
    std::string Hostname::getFullHostname()
    {
        ...
        char lvBuffer[ 1025 ];
        int lvError;
        hp = gethostbyname_r( lvCanononicalName.c_str(), & lvHostEntry, lvBuffer,
                              sizeof( lvBuffer ), & lvError );
