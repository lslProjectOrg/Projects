...
SmartTraderQTMVCMainWindow::SmartTraderQTMVCMainWindow(QWidget *parent)
    : QMainWindow(parent)
{
    setupUi(this);
...
void SmartTraderQTMVCMainWindow::insertChild()
{
...
bool SmartTraderQTMVCMainWindow::insertColumn(const QModelIndex &parent)
{
    QAbstractItemModel *model = view->model();
...
void SmartTraderQTMVCMainWindow::insertRow()
{
    QModelIndex index = view->selectionModel()->currentIndex();
    QAbstractItemModel *model = view->model();
...
bool SmartTraderQTMVCMainWindow::removeColumn(const QModelIndex &parent)
{
    QAbstractItemModel *model = view->model();
    int column = view->selectionModel()->currentIndex().column();
...
void SmartTraderQTMVCMainWindow::removeRow()
{
    QModelIndex index = view->selectionModel()->currentIndex();
    QAbstractItemModel *model = view->model();
...
void SmartTraderQTMVCMainWindow::updateActions()
{
