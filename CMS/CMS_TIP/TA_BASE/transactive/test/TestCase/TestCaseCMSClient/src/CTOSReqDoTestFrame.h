#ifndef __CLIENT_TO_SERVER_REQ_DO_TEST_FRAME__HH__
#define __CLIENT_TO_SERVER_REQ_DO_TEST_FRAME__HH__
...
class CTOSReqDoTestFrame
{
public:
	CTOSReqDoTestFrame(void);
	~CTOSReqDoTestFrame(void);
...
#endif //__CLIENT_TO_SERVER_REQ_DO_TEST_FRAME__HH__
