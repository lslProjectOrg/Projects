...
{
	_SysLog(LogSourceFLInfo, TA_Base_Test::DebugTrace, "CBoostThread");
...
{
	_SysLog(LogSourceFLInfo, TA_Base_Test::DebugTrace, "runThread");
	...
	_SysLog(LogSourceFLInfo, TA_Base_Test::DebugDebug, "runThread(): [Thrd: %d] begin  call run()", myThread->m_nThreadID );
