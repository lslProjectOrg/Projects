...
* in any form.
*
* Source: $File: //depot/3001_TIP_NEW/TA_BASE/transactive/core/data_access_interface/src/IDatabase.h $
* @author Nick Jardine
* @version $Revision: #5 $
* Last modification: $DateTime: 2013/06/11 10:08:41 $
...
#include "core/database/src/IData.h"
#include "core/database/src/sqldef.h"
...
namespace TA_Base_Core
{
	...
	public:
		...
		*/
		...
		virtual IData* executeQuery(const SQLStatement& rSqlObj, const std::vector<std::string>& columnNames, const unsigned long numRows) =0;
		...
		*      connect() MUST be called prior to this method   
		*/
		virtual IData* executeProcedure(const SQLStatement& rSqlObj, const std::vector<std::string>& columnNames, const unsigned long numRows = 500) =0;
