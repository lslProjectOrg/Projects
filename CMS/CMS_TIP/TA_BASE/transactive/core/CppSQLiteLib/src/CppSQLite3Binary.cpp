...
*/
int CppSQLite3Binary::sqlite3_encode_binary(const unsigned char *in, int n, unsigned char *out)
{
	int i, j, e, m;
	int cnt[256];
	if( n<=0 ){
...
*/
int CppSQLite3Binary::sqlite3_decode_binary(const unsigned char *in, unsigned char *out)
{
	int i, c, e;
	e = *(in++);
	i = 0;
