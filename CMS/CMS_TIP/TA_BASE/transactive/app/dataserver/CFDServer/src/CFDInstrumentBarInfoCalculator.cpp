...
//////////////////////////////////////////////////////////////////////////
CCFDInstrumentBarInfoCalculator::CCFDInstrumentBarInfoCalculator(const CCFDRequest& cfdRequest)
{	
	BOOST_LOG_FUNCTION();
...
int CCFDInstrumentBarInfoCalculator::_ClearDataInMap(MapIntervalBarInfoT*  pMapTimeBarInfo)
{
	...
	while(iterMap != m_pMapTimeBarInfo->end())
	{
		...
		//log bar
		sreaamTmp.str("");
		sreaamTmp<<"last save cfd bar"
			<<" "<<"m_nInstrumentIDFirest="<<m_CFDRequest.m_nCFDInstrumentIDFirst
			<<" "<<"m_nInstrumentIDSecond="<<m_CFDRequest.m_nCFDInstrumentIDSecond;
