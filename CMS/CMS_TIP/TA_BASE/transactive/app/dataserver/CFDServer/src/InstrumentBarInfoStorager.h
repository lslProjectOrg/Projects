...
public:
	...
	*/
	CInstrumentBarInfoStorager(const std::string& strPathInstrumentBarInfoTotal, unsigned int nInstrumentID);
...
private:
	...
	int _StoreBarInfoBatchMode(LstInstrumentBarInfoT* pLstInstrumentBarInfo);
private:
...
private:
	...
	std::string  m_strPathInstrumentBarInfoTotal;

	LstInstrumentBarInfoT*  m_pLstInstrumentBarInfo;
